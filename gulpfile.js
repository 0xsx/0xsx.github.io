...
gulp.task("js-production", ["eslint"], function() {
  return gulp.src(jsFiles)
    ...
    .pipe(webpack({
      ...
      mode: "development",  // There is a bug with the hashrouter and production mode.
      module: {
        rules: [
          {
            test: /\.jsx?$/,
...
gulp.task("img-development", function() {
  return gulp.src("src/img/**")
    .pipe(plumber(plumberOptions))
    .pipe(gulp.dest("dist/development/src/img"))
...
gulp.task("models-development", function() {
  return gulp.src("src/models/**")
    .pipe(plumber(plumberOptions))
    .pipe(gulp.dest("dist/development/src/models"))
    .pipe(notify({ message: "Models built for development" }));
});
...
gulp.task("dev", ["js-development", "html-development", "css-development", "img-development", "models-development"]);
gulp.task("build", ["js-production", "html-production", "css-production"]);
...
gulp.task("watch", function() {
  ...
  gulp.watch("src/models/**", ["models-development"]);
